      ...
      >
        ...
        <View style={styles.menuCard}>
          ...
          <MenuRow icon="chart-line" label="Your Impact & ROI" sub="See money saved, value added & next-best projects"
            testID="profile-roi" onPress={() => router.push("/roi")} />
          ...
          <MenuRow icon="file-chart-outline" label="Reports & Export" sub="Custom data exports, reports & secure share links"
            testID="profile-export" onPress={() => router.push("/export")} />
          <MenuRow icon="puzzle-outline" label="Integrations" sub="Connect trusted add-ons & manage data access"
            testID="profile-appstore" onPress={() => router.push("/appstore")} />
          <MenuRow icon="shield-check-outline" label="Privacy & Activity" sub="Your activity log, data use & consent controls"
